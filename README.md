...
| `references/70-golden-set/e2e-01-severnaya/` | **A worked example**: the company profile that goes in, and the six-section strategy that comes out — nine pages plus a single-file `strategy.html`. Built by `build-html.py`, no dependencies |
