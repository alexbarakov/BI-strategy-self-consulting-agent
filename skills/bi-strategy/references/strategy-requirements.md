...
- **Экономическая модель как обязательный раздел.** Нужна, когда защищается бюджет; её отсутствие не делает стратегию неполной, но требует ответа, почему бизнес-кейса нет.
