...
5. **Интервьюеры + score card** — рубрикаторы по каждому блоку, расхождения калибруются; AI-обвес снимает рутину фиксации. **Рекомендация = min(hard, soft)** — для подтверждения грейда нужен результат в обеих частях; защита и от завышения, и от занижения.

*AI-обвес:* запись и транскрипция интервью, автопроверка задач, LLM-агент с выводами по компетенциям матрицы.

## Воронка

HR-скрининг → **тех.сессия (55 мин, новая)** → **кейс-секция (85 мин, новая)** → финал у нанимающего менеджера → culture fit без изменений. Тех.часть 140 минут при лимите 150.
