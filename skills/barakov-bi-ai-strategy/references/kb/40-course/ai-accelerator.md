...
**Формат:** 8 недель, четыре этапа — сбор заявок → разработка в командах → питчинги → голосование и выбор победителей. Четыре номинации: эффективность · бизнес-импакт · синергия с платформой · народное голосование. Критерии оценки: бизнес-ценность · практическая применимость · потенциал масштабирования · переиспользуемость · качество реализации. Оценивают трое: **AI-судья · жюри хедов и лидов платформы · народное голосование**.

Специфика: полная свобода идей · поддержка менторами · **4 недели на проработку — не хакатон** · «вайб стартапов».

**Результаты:** 39 проектов заявлено → 24 доведено до питча (61%) · 9 заехали в прод в плагинах · 69 человек в командах, 9 менторов · ~250 уникальных зрителей на эфирах питчингов · **GenAI adoption в аналитике 0 → 73%** (доля аналитиков с активным использованием локальных агентов за 3 месяца) · **покрытие скиллами основных JTBD 0 → 72%** по объёму задач аналитиков.
