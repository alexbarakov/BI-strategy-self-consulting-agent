...
Рендер `30-graph.yaml`. **Сплошные стрелки** — курируемые типизированные связи из секции `relations`. **Пунктир** — связи, выведенные из содержания и живущие в атомах как обычные wiki-ссылки Obsidian.
